...
ActiveRecord::Schema.define(version: 20180328180958) do
  ...
  create_table "menu_orders", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.bigint "topping_id"
    t.index ["item_id"], name: "index_menu_orders_on_item_id"
    t.index ["order_id"], name: "index_menu_orders_on_order_id"
    t.index ["topping_id"], name: "index_menu_orders_on_topping_id"
  end
